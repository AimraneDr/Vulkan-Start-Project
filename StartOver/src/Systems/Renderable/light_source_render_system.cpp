...
namespace Systems {
	...
	void PointLightRenderSystem::update(SO::FrameInfo& frameInfo, SO::GlobalUBO& ubo) {
		...
		for (auto& e : mEntities) {
			auto& objT = SO::GameObject::Manager.GetComponent<Components::TransformComponent>(e);
			auto& objPL = SO::GameObject::Manager.GetComponent<Components::PointLightComponent>(e);

...
namespace SO {
	...
	public:
		...
		SwapChain(RendererDevice& deviceRef, VkExtent2D windowExtent);
		SwapChain(RendererDevice& deviceRef, VkExtent2D windowExtent, std::shared_ptr<SwapChain> previouse);
		~SwapChain();

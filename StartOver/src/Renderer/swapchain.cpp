...
namespace SO {
    ...
    SwapChain::SwapChain(RendererDevice& deviceRef, VkExtent2D extent)
        : device{ deviceRef }, windowExtent{ extent } {
        init();
    }
    SwapChain::SwapChain(RendererDevice& deviceRef, VkExtent2D extent, std::shared_ptr<SwapChain> previouse)
        : device{ deviceRef }, windowExtent{ extent }, oldSwapChain{ previouse } {
        init();

        //clean up old sawpChain
    ...
    SwapChain::~SwapChain() {
        ...
        for (int i = 0; i < colorImages.size(); i++) {
            ...
            vkFreeMemory(device.device(), colorImageMemories[i], nullptr);
        }
